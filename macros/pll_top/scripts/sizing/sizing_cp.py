...
# Description: Analytical (gm/ID) sizing of the cp macro.
#
# The specifications live in specs_cp.py — edit that file, not this
...
# scripts/sizing/sizing_cp.md (specs + computed sizing).
#
...
import specs_cp as specs

SPECS_FILE = Path(__file__).resolve().parent / "specs_cp.py"
REPORT_FILE = Path(__file__).resolve().parent / "sizing_cp.md"
# ============================================


def main():
    r = Report("cp", generator=Path(__file__).name)
    r.specs(SPECS_FILE)
